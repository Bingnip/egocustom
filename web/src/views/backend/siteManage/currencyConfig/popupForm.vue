        ...
        <el-scrollbar v-loading="baTable.form.loading" class="ba-table-form-scrollbar">
            <div class="ba-operate-form" :class="'ba-' + baTable.form.operate + '-form'"
                ...
                <el-form v-if="!baTable.form.loading" ref="formRef" @submit.prevent=""
                    ...
                    <FormItem :label="t('siteManage.currencyConfig.crc_default')" type="checkbox" prop="crc_default"
                    ...
                    <FormItem :label="t('State')" type="radio" v-model="baTable.form.items!.crc_status"
                        prop="crc_status" :data="{ childrenAttr: { border: true }, content: { '0': '禁用', '1': '启用' } }"

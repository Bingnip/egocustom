...
const baTable = new baTableClass(
    new baTableApi('/admin/siteManage.CurrencyConfig/'),
    {
        ...
        column: [
            ...
            { label: t('siteManage.currencyConfig.crc_code'), prop: 'crc_code', align: 'center', width: 70, operator: false },
            { label: t('siteManage.currencyConfig.crc_name'), prop: 'crc_name', align: 'center', width: 130 },
            { label: t('siteManage.currencyConfig.crc_sign'), prop: 'crc_sign', align: 'center', width: 70, operator: false },
            { label: t('siteManage.currencyConfig.crc_rate') + '（与美元）', prop: 'crc_rate', align: 'center', width: 130, operator: false },
            { label: t('siteManage.currencyConfig.crc_exchange_rate'), prop: 'crc_exchange_rate', align: 'center', width: 130, operator: false },
            ...
            {
                label: t('siteManage.currencyConfig.crc_created_at'),
                prop: 'crc_created_at',
                align: 'center',
                render: 'datetime',
                width: 130,
            ...
            {
                label: t('siteManage.currencyConfig.crc_updated_at'),
                prop: 'crc_updated_at',
                align: 'center',
                render: 'datetime',
                width: 130,
            ...
            { label: t('siteManage.currencyConfig.crc_memo'), prop: 'crc_memo', align: 'center', width: 130, operator: false },
